...
import mk.ukim.finki.wpaud.service.impl.CategoryServiceImpl;
...
public class ThymeleafCategoryServlet extends HttpServlet
{
    ...
    public ThymeleafCategoryServlet(SpringTemplateEngine springTemplateEngine, CategoryServiceImpl categoryService)
    {
